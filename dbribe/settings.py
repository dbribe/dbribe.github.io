"""
Django settings for dbribe project.
...
AUTH_USER_MODEL = "dbribeapp.User"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "dbribeapp.context_processor.default",
            ],
        },
    },
]
...
PUBLIC_STATE_PATHS = [
    (
        os.path.join(PROJECT_ROOT, "dbribeapp/templates/PublicState.jstemplate"),
        os.path.join(PROJECT_ROOT, "dbribeapp/static/js/PublicState.js")
    ),
]
...
WSGI_APPLICATION = 'dbribe.wsgi.application'
